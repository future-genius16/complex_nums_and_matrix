    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                for (int i = 0; i < rows; i++) {
                    for (int j = 0; j < cols; j++) {
                        System.out.println("Введите действительную часть элемента [" + (i + 1) + "][" + (j + 1) + "]:");
                        double elReal = scanner.nextDouble();
                        System.out.println("Введите мнимую часть элемента [" + (i + 1) + "][" + (j + 1) + "]:");
            ...
            case 5:
                ...
                if (row2 != col1) {
                    System.out.println("Количество столбцов первой матрицы должно совпадать с количеством строк второй матрицы.");
                    break;
                }
...
class Matrix {
    ...
    public Matrix multiply(Matrix other) {
        if (this.elements[0].length != other.elements.length) {
            throw new IllegalArgumentException("Число столбцов первой матрицы должно совпадать с числом строк второй для умножения");
        }
